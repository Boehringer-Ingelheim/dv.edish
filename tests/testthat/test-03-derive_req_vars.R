...
test_that("normalization using ULN reference type" |>
  ...
  expected <- data.frame(
    ...
    .abs_at = c(9.2, 9.3, 6.2),
    .norm_base_uln = c(3.1, 3.1, 6.2) / 5,
...
test_that("display by visit" |>
  ...
  expected <- data.frame(
    ...
    .abs_at = c(9.2, 4.3, 4.2, 9.3, 6.2, 6.2),
    .norm_base_uln = c(3.1, 3.1, 3.1, 3.1, 6.2, 6.2) / 5,
    ...
    .norm_tbili = c(1.92222222222222,
                    ...
                    1.98888888888889),
    .abs_tbili = c(17.3, 17.3, 17.9, 17.9, 17.9, 17.9),
